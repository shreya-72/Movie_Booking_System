...
def test_insert_theaters():
  ...
  for data in data_list:
    ...
    response = requests.post(f"{url}/theater", json = data)
...
def test_update_theaters():
    ...
    try:
        response = requests.put(f"{url}/theater", json=theater_data)
...
def test_delete_theaters():
  ...
  for data in data_list:
    response = requests.delete(f"{url}/theater", json = data)
...
def test_display_theaters():
    ...
    try:
        ...
        response = requests.get(f"{url}/theater", params=query_params)
